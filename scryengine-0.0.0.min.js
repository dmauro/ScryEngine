...
{text:"Continue Game",selection_callback:function(){return a.dismiss(function(){var a;a=(a="undefined"!==typeof localStorage&&null!==localStorage?localStorage.getItem("quicksave"):void 0)||("undefined"!==typeof localStorage&&null!==localStorage?localStorage.getItem("fullsave"):void 0);return c.continue_game(a)})}}]);return a.show()};J.prototype._save_game_data_locally=function(a){a=JSON.stringify(a);"undefined"!==typeof localStorage&&null!==localStorage&&localStorage.setItem("fullsave",a);return"undefined"!==
typeof localStorage&&null!==localStorage?localStorage.removeItem("quicksave"):void 0};J.prototype._save_game_data_remotely=function(a,b){JSON.stringify(a);if("function"===typeof b)return b()};J.prototype._create_from_constructor_string=function(){var a,b;b=arguments[0];a=2<=arguments.length?v.call(arguments,1):[];b=e.utils.constructor_from_string(b);var c=function(){};c.prototype=b.prototype;c=new c;b=b.apply(c,a);return Object(b)===b?b:c};J.prototype.create_game=function(a){this.game=this._create_from_constructor_string(this.config.game_class,
this.config,a);this.game.quicksave_handler=function(a){a=JSON.stringify(a);return"undefined"!==typeof localStorage&&null!==localStorage?localStorage.setItem("quicksave",a):void 0};var b=this;this.game.fullsave_handler=function(a){b._save_game_data_locally(a);return b._save_game_data_remotely(a)};var c=this;return this.game.exit_handler=function(){c.game.fullsave();c.game=null;return c.show_main_menu()}};J.prototype.start_new_game=function(){var a;a=this._create_from_constructor_string(this.config.chargen_class,
e.utils.constructor_from_string(this.config.base_player_thing_class));var b=this;a.on_complete_callback=function(a){b.create_game();b.game.set_protagonist(a);return b.game.start()};return a.start()};J.prototype.continue_game=function(a){this.create_game(a);return this.game.start()};e.Application=J;var Na=e.actions,Da=function(a){this.world=a};Da.prototype.do_action=function(a,b,c,d,f){if(null==b)return f("Action does not exist.");a instanceof e.things.Player&&this.stop_listening_for_actions();return(new b(a.get_host(),
c,this.world,d,f))["do"]()};Na.ActionManager=Da;var Oa=e.actions,sa=function(a,b,c,d,f){this.actor=a;this.data=b;this.world=c;this.success_callback=d;this.failure_callback=f;this.registry=this.actor.registry;this.time=0};sa.prototype._get_time_to_complete=function(){return this.time};sa.prototype["do"]=function(){if("function"===typeof this.success_callback)return this.success_callback(this._get_time_to_complete())};Oa.Base=sa;var Pa=e.actions,O=function(){return O.__super__.constructor.apply(this,
arguments)};l(O,e.actions.Base);O.prototype._tile_is_impassable=function(){return!this.actor.incorporeal?(this.failure_callback("You cannot enter that tile"),!0):!1};O.prototype._tile_is_obstacle=function(){return!this.actor.is_flying?(this.failure_callback("You cannot enter that tile"),!0):!1};O.prototype._thing_is_in_target_location=function(){return this.failure_callback("Something is already on that tile")};O.prototype["do"]=function(){var a,b,c,d,f,e;b=this.actor.x+this.data.x;c=this.actor.y+
this.data.y;a=this.world.get_tile_at(b,c);if(!(a.is_impassable&&this._tile_is_impassable()||a.is_obstacle&&this._tile_is_obstacle())){d=this.registry.get_things_with_position(b,c);f=0;for(e=d.length;f<e;f++)if(a=d[f],this._thing_is_in_target_location(a))return;this.actor.move_to(b,c);return O.__super__["do"].call(this)}};Pa.Move=O;var Qa=e.actions,S=function(){return S.__super__.constructor.apply(this,arguments)};l(S,e.actions.Move);S.prototype._fail_if_movement_is_invalid=function(a,b){if(0===a&&
0===b)return this.failure_callback("You cannot move to the same position you are currently on.");if(!a&&!b||!(-1<=a&&1>=a)||!(-1<=b&&1>=b))return this.failure_callback("You must move to an adjacent location")};S.prototype._get_time_to_complete=function(){return this.time*(this.actor.speed||1)};S.prototype["do"]=function(){var a,b;a=Math.abs(this.data.x);b=Math.abs(this.data.y);this._fail_if_movement_is_invalid(a,b);this.time=1===a&&1!==b||1!==a&&1===b?1:1.4;var c=this;return setTimeout(function(){return S.__super__["do"].call(c)},
100)};Qa.Walk=S;var Ra=e.events,ta=function(a,b,c){var d;this.name=a;null==b&&(b={});this.parent_event=c;for(d in b)if(k.call(b,d)){a=b[d];if(null!=this.key)throw Error("Trying to override a reserved event property: "+d);this[d]=a}};ta.prototype.get_root_event=function(){var a;for(a=this;null!=a.parent_event;)a=a.parent_event;return a};ta.prototype.get_callstack=function(){var a;a=this.get_root_event;return a.callstack||(a.callstack=[])};Ra.Base=ta;var Sa=e.events,ua=function(){var a,b;b=arguments[0];
a=2<=arguments.length?v.call(arguments,1):[];ua.__super__.constructor.apply(this,["property_change",{property:b}].concat(v.call(a)))};l(ua,e.events.Base);Sa.ThingPropertyChange=ua;var Ta=e.events,va=function(){var a,b;b=arguments[0];a=2<=arguments.length?v.call(arguments,1):[];va.__super__.constructor.apply(this,["property_affected",{property:b}].concat(v.call(a)))};l(va,e.events.Base);Ta.ThingPropertyAffected=va;var Ua=e.events,wa=function(){var a,b;b=arguments[0];a=2<=arguments.length?v.call(arguments,
1):[];wa.__super__.constructor.apply(this,[""+b+"_affected"].concat(v.call(a)))};l(wa,e.events.Base);Ua.ThingSpecificPropertyAffected=wa;var Va=e.events,xa=function(){var a,b,c,d,f,e,h;f=arguments[0];e=arguments[1];h=arguments[2];b=arguments[3];c=arguments[4];d=arguments[5];a=7<=arguments.length?v.call(arguments,6):[];xa.__super__.constructor.apply(this,["sprite_moved",{x:f,y:e,z:h,prev_x:b,prev_y:c,prev_z:d}].concat(v.call(a)))};l(xa,e.events.Base);Va.SpriteMoved=xa;var Wa=e.events,T=function(){};
T.prototype._get_events=function(){return this._events||(this._events={})};T.prototype._get_listeners=function(a){var b;b=this._get_events();return b[a]||(b[a]=[])};T.prototype.on=function(a,b,c){var d,f,e,h;if("function"===typeof b){d=this._get_listeners(a);a=!1;e=0;for(h=d.length;e<h;e++)if(f=d[e],f.listener===b){a=!0;break}a||d.push({listener:b,scope:c||this});return this}};T.prototype.off=function(a,b){var c,d,f,g;if(b){c=this._get_listeners(a);f=0;for(g=c.length;f<g;f++)if(d=c[f],d.listener===
b){e.utils.remove_val_from_array(c,d);c.length||this.remove_event(a);break}}else a?this.remove_event(a):this._events={};return this};T.prototype.remove_event=function(a){a?this._get_events()[a]=void 0:this._events=void 0;return this};T.prototype.trigger=function(a,b){var c,d;null==b&&(b=function(){});a.target=this;d=this._get_listeners(a.name);c=function(f){var e;if(null==d[f])return b();e=d[f].listener.call(d[f].scope,a,function(a){return!0===a?b():c(f+1)});if(!0===e)return b();if(!1!==e)return c(f+
1)};return c(0)};Wa.EventEmitter=T;var K=function(a){null!=a?this._restore(a):this._init()};K.prototype._init=function(){this.current_game_id=null;this.preferences={};this.games=[];return this.bones=[]};K.prototype._restore=function(a){var b,c,d;"string"===typeof a&&(a=JSON.parse(a));d=[];for(b in a)k.call(a,b)&&(c=a[b],d.push(this[b]=c));return d};K.prototype.get_save_data=function(){return this};K.prototype.new_game=function(){var a;a=new e.Game;this.games.push(a.id);this.current_game_id=a.id;return a};
K.prototype.end_game=function(a){var b;b=this.games.indexOf(a);this.games.splice(b,1);this.current_game_id=null;return this.bones.push(a)};K.prototype.get_gamesave_from_remote=function(a,b){return b(null)};K.prototype.restore_game_from_id=function(a,b){return this.get_gamesave_from_remote(a,function(a){return b(new e.Game(this,a))})};K.prototype.restore_current_game=function(a){var b;if(!this.current_game_id)return a(new e.Game(this));b="undefined"!==typeof localStorage&&null!==localStorage?localStorage.getItem("quicksave"):
void 0;null!=b&&JSON.parse(b).id===this.current_game_id||this.get_gamesave_from_remote(this.current_game_id,function(b){return function(d){return null==d?a(new e.Game(b)):a(new e.Game(b,d))}}(this));return a(new e.Game(this,b))};e.User=K;var ya=function(a){this.character=new a};ya.prototype.start=function(){var a;a=new e.ui.components.Query;a.data_source=new e.ui.components.data_sources.QueryDataSource("What's your character's name?",null,[{name:"character_name"}]);var b=this;a.on_submit_callback=
function(c){b.character.fullname=c.character_name;return a.dismiss(function(){return b.finish()})};return a.show()};ya.prototype.finish=function(){if(null!=this.on_complete_callback)return this.on_complete_callback(this.character)};e.CharacterGenerator=ya;var u=function(a,b){null!=b?"string"===typeof b?this._restore(a,b):this._init(a,b):this._init(a);this.perception_manager=new e.perception.PerceptionManager;this.timekeeper.bind_to_registry(this.registry);this.world.bind_to_registry(this.registry);
this.perception_manager.bind_to_registry(this.registry);var c=this;this.registry.display_message_to_console=function(){return c.display_message_to_console.apply(c,arguments)};var d=this;this.timekeeper.turn_offered_handler=function(){if(d.map)return d.map.draw_map()};this.action_manager.stop_listening_for_actions=function(){return"undefined"!==typeof keypress&&null!==keypress?keypress.stop_listening():void 0}};u.prototype._create_from_constructor_string=function(){var a,b;b=arguments[0];a=2<=arguments.length?
...
e.ui.components,L=function(){return L.__super__.constructor.apply(this,arguments)};l(L,e.ui.components.Base);L.prototype.styles=["menu"];L.prototype.render=function(){var a,b,c,d;b=this.create_element("ul");a=c=0;for(d=this.data_source.length;0<=d?c<d:c>d;a=0<=d?++c:--c)b.appendChild(this.create_element("li",this.create_element("span",""+this.data_source.get_option_text_at_index(a))));return b};L.prototype.bind_events=function(){var a;a=this;return $("#"+this.namespace+" li").on("click",function(){var b;
b=a.data_source.get_option_selection_callback_at_index($(this).index());if(null!=b)return b()})};L.prototype.unbind_events=function(){return $(""+this.namespace+" li").off("click")};L.prototype.animate_appearance=function(a){this.element.setAttribute("style","opacity:0;top:-500px;position:relative");return $(this.element).animate({opacity:1,top:0},500,a)};L.prototype.animate_disapperance=function(a){return $(this.element).animate({opacity:0},200,a)};kb.Menu=L;var lb=e.ui.components,Q=function(){return Q.__super__.constructor.apply(this,
arguments)};l(Q,e.ui.components.Base);Q.prototype.styles=["query"];Q.prototype.render=function(){var a,b,c,d,e,g,h;a=this.create_element("div",this.data_source.query_title?this.create_element("h1",this.data_source.query_title):null,e=this.create_element("ul"));b=g=0;for(h=this.data_source.length;0<=h?g<h:g>h;b=0<=h?++g:--g)c=this.data_source.get_query_label_at_index(b),d=this.create_element("li"),c&&d.appendChild(this.create_element("label",c)),d.appendChild(this.create_element("input",{type:"text",
name:""+this.data_source.get_query_name_at_index(b)})),e.appendChild(d);a.appendChild(this.create_element("button",{type:"submit"},this.data_source.submit_label||"Submit"));return a};Q.prototype.bind_events=function(){return $("#"+this.namespace+" button").on("click",function(a){return function(){return a.submit_query()}}(this))};Q.prototype.unbind_events=function(){return $("#"+this.namespace+" button").off("click")};Q.prototype.submit_query=function(){var a;if(null!=this.on_submit_callback)return a=
{},$("#"+this.namespace+" input").each(function(b,c){return a[c.getAttribute("name")]=c.value}),this.on_submit_callback(a)};lb.Query=Q;var mb=e.ui.components,w=function(){return w.__super__.constructor.apply(this,arguments)};l(w,e.ui.components.Base);w.prototype.styles=["tile_map"];w.prototype.__defineGetter__("data_source",function(){return this._data_source});w.prototype.__defineSetter__("data_source",function(a){this._data_source=a;this.viewport_width=2*a.view_width*a.tile_width+a.tile_width;return this.viewport_height=
2*a.view_height*a.tile_height+a.tile_height});w.prototype.render=function(){this.background_element=this.create_element("canvas",{id:""+this.namespace+"_background","class":"canvas_background",width:this.viewport_width,height:this.viewport_height});this.lighting_element=this.create_element("canvas",{id:""+this.namespace+"_lighting","class":"canvas_lighting",width:this.viewport_width,height:this.viewport_height});this.foreground_element=this.create_element("canvas",{id:""+this.namespace+"_foreground",
...
w.prototype.draw_map=function(){return this.should_draw_map=!0};w.prototype._draw_map=function(){var a,b,c,d,e,g;a=this.data_source.center_x;c=this.data_source.center_y;g=this.data_source.z;b=this.center_x-a;d=this.center_y-c;e=g!==this.z;this.center_x=a;this.center_y=c;this.z=g;a=this.data_source.update_light_map({top:this.center_y-this.data_source.view_height,bottom:this.center_y+this.data_source.view_height,left:this.center_x-this.data_source.view_width,right:this.center_x+this.data_source.view_width});
this.draw_background(b,d,e);this.draw_foreground();this.draw_lighting(b,d,e,a);return this.draw_composite()};w.prototype.draw_background=function(a,b,c){var d,f,g,h,i,m,n,k,j,l,o,p,q,r,u,v,w;d=this.background_element.getContext("2d");h=this.data_source;r=h.view_width;q=h.view_height;o=h.tile_width;l=h.tile_height;c||d.drawImage(this.background_element,a*o,b*l);n=m=0;i=this.center_x-r;k=this.center_x+r;p=this.center_y-q;f=this.center_y+q;for(u=v=p;p<=f?v<=f:v>=f;u=p<=f?++v:--v){for(g=w=i;i<=k?w<=k:
w>=k;g=i<=k?++w:--w){if(c||m<a||m>2*r+a||n<b||n>2*q+b)j=h.get_tile_at(g,u),g="#000",j&&("engine.geography.tiles.Floor"===j.constructor.cname?g="#AAA":"engine.geography.tiles.Wall"===j.constructor.cname&&(g="#844")),d.fillStyle="rgba("+e.utils.hex_to_rgb(g)+", 1)",d.fillRect(m*o,n*l,o,l);m+=1;m>=2*r+1&&(m=0)}n+=1}};w.prototype.draw_foreground=function(){var a;a=this.foreground_element.getContext("2d");a.fillStyle="rgba("+e.utils.hex_to_rgb("#00FF00")+", 1)";console.log("FILL STYLE: "+a.fillStyle);
return a.fillRect(this.data_source.view_width*this.data_source.tile_width,this.data_source.view_height*this.data_source.tile_height,this.data_source.tile_width,this.data_source.tile_height)};w.prototype.draw_lighting=function(){var a,b,c,d,f,g,h,i,m,k,j,l,o,p,q,r;d=this.lighting_element.getContext("2d");b=this.data_source;m=b.view_width;i=b.view_height;h=b.tile_width;g=b.tile_height;l=o=0;for(q=this.viewport_height/g;0<=q?o<q:o>q;l=0<=q?++o:--o){j=p=0;for(r=this.viewport_width/h;0<=r?p<r:p>r;j=0<=
r?++p:--p)if(a=j+(this.center_x-m),c=l+(this.center_y-i),k=b.visibility_at_point(a,c),f=1-k,d.clearRect(j*h,l*g,h,g),0<f&&(d.globalCompositeOperation="source-over",d.fillStyle="rgba(0, 0, 0, "+f+")",d.fillRect(j*h,l*g,h,g)),0<k)a=b.light_color_at_point(a,c),a=e.utils.hex_to_rgb(a),d.globalCompositeOperation="lighten",d.fillStyle="rgba("+a+", 1)",d.fillRect(j*h,l*g,h,g)}};w.prototype.draw_composite=function(){var a;a=this.composite_element.getContext("2d");a.globalCompositeOperation="source-over";
a.drawImage(this.background_element,0,0);a.drawImage(this.foreground_element,0,0);a.globalCompositeOperation="multiply";return a.drawImage(this.lighting_element,0,0)};mb.TileMap=w;var nb=e.ui.components.data_sources,za=function(){};za.prototype.remove=function(){return this.undbind_events()};za.prototype.undbind_events=function(){};nb.Base=za;var ob=e.ui.components.data_sources,ga=function(a){this._menu_options=a};l(ga,e.ui.components.data_sources.Base);ga.prototype.__defineGetter__("length",function(){return this._menu_options.length});
ga.prototype.get_option_text_at_index=function(a){return this._menu_options[a].text};ga.prototype.get_option_selection_callback_at_index=function(a){return this._menu_options[a].selection_callback};ob.MenuDataSource=ga;var pb=e.ui.components.data_sources,W=function(a,b,c){this._title=a;this._submit_label=b;this._queries=c};l(W,e.ui.components.data_sources.Base);W.prototype.__defineGetter__("length",function(){return this._queries.length});W.prototype.__defineGetter__("query_title",function(){return this._title});
W.prototype.__defineGetter__("submit_label",function(){return this._submit_label});W.prototype.get_query_label_at_index=function(a){return this._queries[a].label};W.prototype.get_query_name_at_index=function(a){return this._queries[a].name};pb.QueryDataSource=W;var qb=e.ui.components.data_sources,E=function(a,b){this.world=a;this.view_width=b.view_width;this.view_height=b.view_height;this.tile_width=b.tile_width;this.tile_height=b.tile_height;this.protagonist=this.world.get_protagonist();this.host=
...
r.prototype.unbind_events=function(){return this.off()};r.prototype.registry_available=function(a){return this.registry=a};r.prototype.get_save_data=function(){var a,b,c,d;a={};c=["_events","_property_modifier_handlers","registry"];for(b in this)k.call(this,b)&&(d=this[b],0<=R.call(c,b)||(a[b]=d));return a};r.prototype.remove=function(){return this.off()};rb.Base=r;var sb=e.things,oa=function(){return oa.__super__.constructor.apply(this,arguments)};l(oa,e.things.Base);oa.cname="engine.things.Abstract";
sb.Abstract=oa;var tb=e.things,y=function(){return y.__super__.constructor.apply(this,arguments)};l(y,e.things.Abstract);y.cname="engine.things.LightSource";e.things.define_defaults.call(y,{intensity:0,color:"ffffff"});e.things.define_getter.call(y,"has_target",function(){return null!=this._target});e.things.define_getter.call(y,"x",function(){var a;null==this._x&&(a=this.registry.get_thing(this._target),this._x=null!=a?a.x:void 0);return this._x});e.things.define_getter.call(y,"y",function(){var a;
null==this._y&&(a=this.registry.get_thing(this._target),this._y=null!=a?a.y:void 0);return this._y});e.things.define_setter.call(y,"intensity",function(a){var b;b=this._intensity;this._intensity=a;return this.trigger(new e.events.Base("light_intensity_updated",{value:a,prev_value:b}))});e.things.define_setter.call(y,"color",function(a){this._color=a;return this.trigger(new e.events.Base("light_color_updated",{value:a}))});y.prototype.registry_available=function(a){var b;b=this._target;if(null!=b)return a=
a.get_thing(b),a.on("sprite_moved",this._sprite_moved,this)};y.prototype.apply=function(a){this._x=a.x;this._y=a.y;this._target=a.id;a.add_light_source(this);a.on("sprite_moved",this._sprite_moved,this);return this.trigger(new e.events.Base("light_applied"))};y.prototype.remove=function(a){a=a||this.registry.get_thing(this._target);a.remove_light_source(this);this._target=void 0;return a.off("sprite_moved",this._sprite_moved,this)};y.prototype._sprite_moved=function(a){this._x=a.x;this._y=a.y;return this.trigger(new e.events.Base("light_position_updated",
{x:a.x,y:a.y,prev_x:a.prev_x,prev_y:a.prev_y}))};tb.LightSource=y;var ub=e.things,M=function(){return M.__super__.constructor.apply(this,arguments)};l(M,e.things.Base);M.cname="engine.things.NonAbstract";e.things.define_defaults.call(M,{x:null,y:null,z:null});e.things.define_getter.call(M,"x",function(){if(null!=this._x)return this._x;if(null!=this._owner)return this._owner.x});e.things.define_getter.call(M,"y",function(){if(null!=this._y)return this._y;if(null!=this._owner)return this._owner.y});
e.things.define_getter.call(M,"z",function(){if(null!=this._z)return this._z;if(null!=this._owner)return this._owner.z});M.prototype.change_constructor=function(a){return new a(this.get_save_data())};ub.NonAbstract=M;var vb=e.things,p=function(a){var b,c;this.things={};null!=a?this._restore(a):this._init();c=this.things;for(b in c)a=c[b],null!==a&&a.activate_method_throughout_chain("registry_available",this)};l(p,e.events.EventEmitter);p.prototype._restore_thing_from_serial_data=function(a){return this.constructor_manager.restore_object_from_data(a)};
...
{id:a.id,thing:a}))};p.prototype.cache_thing=function(a){var b,c;b=this.things[a];b.activate_method_throughout_chain("unbind_events");c=JSON.stringify(this._prepare_thing_for_storing(b));"undefined"!==typeof localStorage&&null!==localStorage&&localStorage.setItem("thing_cache_"+b.id,c);this.things[b.id]=null;this.trigger(new e.events.Base("cached_thing",{id:a,thing:b}));if(b instanceof e.things.Brain)return this.trigger(new e.events.Base("cached_brain",{id:a,thing:b}))};p.prototype.remove_cached_things_from_local_storage=
function(){var a,b,c,d;c=this.things;d=[];for(a in c)b=c[a],null===b?d.push("undefined"!==typeof localStorage&&null!==localStorage?localStorage.removeItem("thing_cache_"+a):void 0):d.push(void 0);return d};p.prototype.uncache_thing=function(a){var b;b=this._restore_thing_from_serial_data(JSON.parse("undefined"!==typeof localStorage&&null!==localStorage?localStorage.getItem("thing_cache_"+a):void 0));"undefined"!==typeof localStorage&&null!==localStorage&&localStorage.removeItem("thing_cache_"+a);
this.things[a]=b;this.trigger(new e.events.Base("uncached_thing",{id:a,thing:b}));b instanceof e.things.Brain&&this.trigger(new e.events.Base("uncached_brain",{id:a,thing:b}));return b};p.prototype.get_thing=function(a){var b;b=this.things[a];null===b&&(b=this.uncache_thing(a));return b};p.prototype.get_things_with_position=function(a,b){var c,d,e,g;d=[];g=this.things;c=e=0;for(g=g.length;e<g;c=++e)c.x===a&&c.y===b&&d.push(c);return c};p.prototype._get_save_data=function(){return{things:{},cached_things:{},
id_count:this.id_count,constructor_manager:this.constructor_manager.get_save_data()}};p.prototype._get_quicksave_data=function(){var a,b,c,d;b=this._get_save_data();d=this.things;for(a in d)k.call(d,a)&&(c=d[a],b.things[a]=null===c?null:this._prepare_thing_for_storing(c));return b};p.prototype._get_fullsave_data=function(){var a,b,c,d;b=this._get_save_data();d=this.things;for(a in d)k.call(d,a)&&(c=d[a],null===c?b.cached_things[a]="undefined"!==typeof localStorage&&null!==localStorage?localStorage.getItem("thing_cache_"+
a):void 0:b.things[a]=this._prepare_thing_for_storing(c));return b};p.prototype.get_save_data=function(a){return!0===a?this._get_quicksave_data():this._get_fullsave_data()};vb.Registry=p;var wb=e.things,X=function(){return X.__super__.constructor.apply(this,arguments)};l(X,e.things.Abstract);X.cname="engine.things.Effect";e.things.define_defaults.call(X,{type:null,target:null,level:0,duration:!1});X.prototype.apply=function(a){this._target=a.id;a.add_effect(this);if(!this._duration)return this.remove(a)};
X.prototype.remove=function(a){a=a||this.registry.get_thing(this._target);return a.remove_effect(this)};wb.Effect=X;var xb=e.things,Y=function(){return Y.__super__.constructor.apply(this,arguments)};l(Y,e.things.Abstract);Y.cname="engine.things.Effect";e.things.define_defaults.call(Y,{type:null,target:null,level:0,duration:!1});Y.prototype.apply=function(a){this._target=a.id;a.add_effect(this);if(!this._duration)return this.remove(a)};Y.prototype.remove=function(a){a=a||this.registry.get_thing(this._target);
return a.remove_effect(this)};xb.Effect=Y;var yb=e.things,z=function(){return z.__super__.constructor.apply(this,arguments)};l(z,e.things.Abstract);z.cname="engine.things.Condition";e.things.define_defaults.call(z,{target:null,source:null,length:0,counter:0,canceling_events:[]});z.prototype.apply=function(a,b){this._target=a.id;null!=b&&(this._source=b.id);this._on();0===this._length&&this._off();return this._bind_events()};z.prototype.remove=function(){this._unbind_events();if(null!=this._target)return this._off()};
z.prototype.registry_available=function(a){this.registry=a;return this._bind_events()};z.prototype._bind_events=function(){var a,b,c,d,e,g;if(null!=this._target){b=this.registry.get_thing(this._target);if(0<this._length)b.on("tick",this._tick_handler,this);e=this.canceling_events;g=[];c=0;for(d=e.length;c<d;c++)a=e[c],g.push(b.on(a,this.remove,this));return g}};z.prototype._unbind_events=function(){var a,b,c,d,e,g;if(null!=this._target){b=this.registry.get_thing(this._target);b.off("tick",this._tick_handler);
e=this.canceling_events;g=[];c=0;for(d=e.length;c<d;c++)a=e[c],g.push(b.off(a,this.remove));return g}};z.prototype._tick_handler=function(a){this._tick(a.time);this.counter+=a.time;if(this.counter>=this._length)return this.remove()};z.prototype._on=function(){};z.prototype._off=function(){};z.prototype._tick=function(){};yb.Condition=z;var zb=e.things,F=function(){return F.__super__.constructor.apply(this,arguments)},Ga,Ha,pa,Ia,Aa;l(F,e.things.NonAbstract);F.cname="engine.things.Sprite";e.things.define_defaults.call(F,
{owner:null,width:null,height:null,size:"medium",light_sources:[],visual_effects:[],sound_effects:[],smell_effects:[],touch_effects:[]});e.things.define_getter.call(F,"width",function(){return null!=this._width?this._width:1});e.things.define_getter.call(F,"height",function(){return null!=this._height?this._height:1});Aa=["visual","sound","smell","touch"];Ha=function(a){return e.things.define_getter.call(F,""+a+"_effects_level",function(){var b,c,d,e,g;c=0;g=this[""+a+"_effects"];d=0;for(e=g.length;d<
...
a.type+"_effects"])return e.utils.remove_val_from_array(b,a.id),this[""+a.type+"_effects"]=b};F.prototype.add_light_source=function(a){var b;b=this.light_sources;b.push(a.id);return this.light_sources=b};F.prototype.remove_light_source=function(a){var b;b=this.light_sources;e.utils.remove_val_from_array(b,a.id);return this.light_sources=b};zb.Sprite=F;var Ab=e.things,ba=function(){return ba.__super__.constructor.apply(this,arguments)};l(ba,e.things.Sprite);ba.cname="engine.things.Sentient";e.things.define_defaults.call(ba,
{brain:null});ba.prototype.give_sentience=function(a){this.brain=a.id;a.set_host(this.id)};Ab.Sentient=ba;var Bb=e.things,N=function(){return N.__super__.constructor.apply(this,arguments)};l(N,e.things.Base);N.cname="engine.things.Brain";e.things.define_defaults.call(N,{host:null,senses:{sight:10,smell:0,hearing:0,touch:1}});N.prototype.take_turn=function(a){return this.do_action(function(b){return function(c){b.trigger(new e.events.Base("tick",{time:c}));return a(c)}}(this))};N.prototype.do_action=
function(a){return a(0)};N.prototype.set_host=function(a){return this.host=a};N.prototype.get_host=function(){return this.registry.get_thing(this.host)};Bb.Brain=N;var Cb=e.things,ha=function(){return ha.__super__.constructor.apply(this,arguments)};l(ha,e.things.Brain);ha.cname="engine.things.Player";ha.prototype.do_action=function(a){this.offerred_turn_handler();return this.listen_for_actions_handler(a,function(b){return function(c){console.log("Error completing action:",c);return b.do_action(a)}}(this))};
Cb.Player=ha;var Db=e.things,qa=function(){return qa.__super__.constructor.apply(this,arguments)};l(qa,e.things.Brain);qa.cname="engine.things.NonPlayer";Db.NonPlayer=qa;e.config={application_class:"engine.Application",game_class:"engine.Game",chargen_class:"engine.CharacterGenerator",base_player_thing_class:"engine.things.Sentient",player_character_class:"engine.things.Player",thing_registry_class:"engine.things.Registry",timekeeper_class:"engine.TimeKeeper",user_settings:{},geography:{zone_manager_class:"engine.geography.ZoneManager",
zone_size:64,loading_buffer:64},ui:{tile_map:{tile_width:20,tile_height:20,view_width:24,view_height:16}}};e.boot_game=function(a){var b;b={};e.utils.deep_extend(b,e.config,a.config);return(new (e.utils.constructor_from_string(b.application_class))(b)).start()};if("function"===typeof define&&define.amd)define([],function(){return e});else if("undefined"!==typeof exports&&null!==exports)for(ra in e)Ba=e[ra],exports[ra]=Ba;else window.engine=e}).call(this);
